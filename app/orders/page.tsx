    ...
    <div className="max-w-7xl mx-auto px-4 md:px-8 py-10">
      ...
      {!user && (
        <div className="bg-white/90 shadow-sm rounded-xl p-6 border border-[#F0E7DE]">
          ...
          <button onClick={() => window.location.href = '/signin'} className="text-sm font-medium px-5 py-2.5 rounded-full bg-[#F4B7C7] text-[#3a2a24] hover:bg-[#f1aabf] transition">Sign In</button>
        </div>
      )}
