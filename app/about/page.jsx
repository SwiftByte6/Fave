      ...
      <div className="relative h-[50vh] bg-gradient-to-r from-pink-100 to-pink-200 flex items-center justify-center">
        <div className="text-center px-6">
          ...
          <p className="text-lg md:text-xl text-gray-700 max-w-2xl mx-auto">
            Crafting beauty through tradition and contemporary design by FAVEE.
          </p>
        </div>
      </div>
      ...
      <div className="py-20 px-6 md:px-16">
        <div className="max-w-5xl mx-auto text-center md:text-left">
          ...
          <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
            <p>
              FAVEE was born from a passion for preserving the timeless beauty of Indian ethnic wear while embracing modern sensibilities. 
    ...
    <div className="grid md:grid-cols-3 gap-10">
      ...
      <div className="bg-white rounded-3xl p-10 text-center shadow-md hover:shadow-2xl transition-all duration-300">
        ...
        <p className="text-gray-600 leading-relaxed">
          ...
          and beauty into every FAVEE creation.
        </p>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 text-left">
            <div className="bg-gradient-to-r from-pink-50 to-white rounded-3xl p-10 shadow-lg hover:shadow-xl transition">
              ...
              <p className="text-lg text-gray-700 mb-6">
                Timeless beauty in every drape. Our FAVEE sarees celebrate traditional weaving while embracing modern styling, 
