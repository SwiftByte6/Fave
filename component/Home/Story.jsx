...
const Story = () => {
  return (
    <section className=' bg-[#F5F2EF] gap-10 md:gap-20 flex items-center justify-center'>
      <div className="flex flex-col md:flex-row gap-20 md:gap-20 justify-center items-center  px-6 py-20 max-w-[93vw]">
        {/* Left: Copy */}
        ...
        <div className="flex-1 flex justify-center items-start">
          <div className="grid grid-cols-2 gap-6">
            <div className="flex flex-col gap-5 items-center">
              <div className="relative w-full max-w-[300px] h-[250px] overflow-hidden rounded-2xl group cursor-pointer">
                <Image
                  src="/s1.jpg"
            ...
            <div className="flex flex-col gap-5 items-center">
              <div className="mt-10  bg-[#eedad3] flex justify-center items-center flex-col w-full max-w-[300px] rounded-2xl h-[130px] text-center">
