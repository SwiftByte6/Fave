...
const Signin: React.FC<SigninProps> = ({ mode = 'signin' }) => {
  ...
  return (
    <div className="relative min-h-[85vh] w-full flex items-center justify-center bg-fav-off-white px-4 py-16 overflow-hidden">
      ...
      <div className="w-full max-w-[460px] bg-white/75 backdrop-blur-xl border border-fav-blush/45 rounded-[2.5rem] p-8 md:p-12 shadow-[0_20px_50px_rgba(122,31,42,0.05)] hover:shadow-[0_25px_60px_rgba(122,31,42,0.08)] transition-all duration-500 flex flex-col items-center z-10">
